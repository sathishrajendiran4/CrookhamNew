...
public class AdminGetRescheduleTaskList extends BaseAdapter {
	...
	public AdminGetRescheduleTaskList(Context context,
			JSONArray imageArrayJson) {
		Context = context;
				...
				if (mTaskstatus.contains("Completed")) {
					...
					if ((mTaskstatus.contains(Context.getText(
						...
						Intent intent = new Intent(Context,
								AdminRescheduleInspection.class);
						...
						Intent intent = new Intent(Context,
								AdminRescheduleDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					}
					else if ((mTaskstatus.contains(Context.getText(
