...
public class AdminRogueingRework extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progressDialog = ProgressDialog.show(AdminRogueingRework.this,
	...
	protected void SendEmailtoCrew() {
		...
		try {
			...
			Toast.makeText(AdminRogueingRework.this,
	...
	protected void SuccessAlert() {
		// TODO Auto-generated method stub
		alertDialog = new AlertDialog.Builder(AdminRogueingRework.this)
				.create();
		...
		alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				alertDialog.dismiss();
				Intent intent = new Intent(AdminRogueingRework.this,
						AdminHome.class);
				startActivity(intent);
			}
		});
