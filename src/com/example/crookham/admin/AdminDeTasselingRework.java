...
public class AdminDeTasselingRework extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progressDialog = ProgressDialog.show(AdminDeTasselingRework.this,
		...
		if (v == baddtask) {
			...
			if (mDate != null && !mDate.isEmpty()) {
				...
				progressDialog = ProgressDialog.show(
						AdminDeTasselingRework.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
	...
	protected void AddTasktoServer() {
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("prefix", "RD"));
			nameValuePairs
					.add(new BasicNameValuePair("tasktype", "Detasseling"));
			nameValuePairs.add(new BasicNameValuePair("status", getText(R.string.activestatus).toString()));
	...
	protected void SendEmailtoCrew() {
		...
		try {
			...
			Toast.makeText(AdminDeTasselingRework.this,
	...
	protected void SuccessAlert() {
		// TODO Auto-generated method stub
		alertDialog = new AlertDialog.Builder(AdminDeTasselingRework.this)
				.create();
		...
		alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				alertDialog.dismiss();
				Intent intent = new Intent(AdminDeTasselingRework.this,
						AdminHome.class);
				startActivity(intent);
			}
		});
