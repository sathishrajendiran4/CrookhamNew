...
public class AdminFreezeDetasseling extends Activity implements OnClickListener {
	...
	String mNumberofWorkers, mStartDate;
	TextView tnoofworkers;
	GPSTracker gps;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) AdminFreezeDetasseling.this
		...
		numberofworkers.setVisibility(View.INVISIBLE);
		tnoofworkers = (TextView) findViewById(R.id.tnumberofworkers);
		tnoofworkers.setVisibility(View.INVISIBLE);
		...
		progressDialog = ProgressDialog.show(AdminFreezeDetasseling.this,
						...
						try {
							...
							for (int i = 0; i < menuitemArray.length(); i++) {
								...
								mStartDate = menuitemArray.getJSONObject(i)
										.getString("startdate");
								tname.append("\n\n"
										+ getText(R.string.numberofworkers)
										+ mNumberofWorkers);
								tname.append("\n\n"
										+ getText(R.string.startdate)
										+ mStartDate);
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(AdminFreezeDetasseling.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								AdminFreezeDetasseling.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(AdminFreezeDetasseling.this,
				AdminGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						AdminFreezeDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (mResponse.contains("Success")) {
						...
						/*
						 * Intent intent = new
						 * Intent(AdminFreezeDetasseling.this,
	...
	private Runnable updateTimerMethod = new Runnable() {
		...
		public void run() {
			...
			finalTime = timeInMillies + timeSwap;
