...
public class AdminReWork extends Activity implements OnClickListener {
	...
	private class GetLastTaskid extends AsyncTask<String, Void, Void> {
		private ProgressDialog Dialog = new ProgressDialog(AdminReWork.this);
	...
	public void onClick(View v) {
		...
		if (v == brework) {
			if (mTasktype.contains("DT")) {
				Intent intent = new Intent(this, AdminDeTasselingRework.class);
			...
			if (mTasktype.contains("RO")) {
				Intent intent = new Intent(this, AdminRogueingRework.class);
				intent.putExtra("locationname", mLocation);
				intent.putExtra("rework", mRework);
				intent.putExtra("taskid", mTaskid);
				startActivity(intent);
		...
		if (v == bnewtask) {
			if (mTasktype.contains("DT")) {
				Intent intent = new Intent(this, AddDeTasseling.class);
				startActivity(intent);
			}
			if (mTasktype.contains("RO")) {
				Intent intent = new Intent(this, AddRogueing.class);
				startActivity(intent);
			}
		}
	}
	...
	private void ErrorinConnection() {
		// TODO Auto-generated method stub
		AlertDialog alertDialog = new AlertDialog.Builder(AdminReWork.this)
				.create();
		...
		alertDialog.setButton("Try Again",
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						// TODO Auto-generated method stub
						Intent intent = new Intent(AdminReWork.this,
								LoginActivity.class);
						startActivity(intent);
					}
				});
	...
	private void callHome() {
		// TODO Auto-generated method stub
		Intent intent = new Intent(AdminReWork.this, AdminHome.class);
		startActivity(intent);
	}
