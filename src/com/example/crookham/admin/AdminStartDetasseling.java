...
public class AdminStartDetasseling extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) AdminStartDetasseling.this
		...
		numberofworkers.setDescendantFocusability(NumberPicker.FOCUS_BLOCK_DESCENDANTS);
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(AdminStartDetasseling.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(AdminStartDetasseling.this,
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								AdminStartDetasseling.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(AdminStartDetasseling.this,
				AdminGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						AdminStartDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (mResponse.contains("Success")) {
						...
						/*
						 * Intent intent = new
						 * Intent(AdminStartDetasseling.this,
