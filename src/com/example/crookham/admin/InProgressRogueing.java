...
public class InProgressRogueing extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) InProgressRogueing.this
		...
		progressDialog = ProgressDialog.show(InProgressRogueing.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(InProgressRogueing.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								InProgressRogueing.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent intent = new Intent(InProgressRogueing.this, AdminGetTasks.class);
		startActivity(intent);
	}
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (mResponse.contains("Success")) {
						...
						// myHandler.postDelayed(updateTimerMethod, 0);
						Intent intent = new Intent(InProgressRogueing.this,
								AdminGetTasks.class);
						startActivity(intent);
					} else {
						ErrorAlert();
