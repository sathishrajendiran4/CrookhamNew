...
public class InProgressDetasseling extends Activity implements OnClickListener,
	...
	String mNumberofWorkers, mStartDate, mComments, mID, Time, mWorkedtime, mServerTime;
	Spinner scomments;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) InProgressDetasseling.this
		...
		progressDialog = ProgressDialog.show(InProgressDetasseling.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(InProgressDetasseling.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								InProgressDetasseling.this).create();
	...
	public void onBackPressed() {
		...
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(InProgressDetasseling.this,
				AdminGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						InProgressDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
