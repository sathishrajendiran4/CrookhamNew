...
public class AdminGetTaskList extends BaseAdapter {
	...
	public AdminGetTaskList(Context context, JSONArray imageArrayJson) {
		Context = context;
			...
			public void onClick(View v) {
				...
				if (mTaskstatus.contains("Completed")) {
					...
					if ((mTaskstatus.contains(Context.getText(
							...
							&& (mTasktype.contains("Inspection"))) {
						Intent intent = new Intent(Context,
								AdminStartInspection.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains("In Progress"))
							&& (mTasktype.contains("Inspection"))) {
						Intent intent = new Intent(Context,
								InProgressInspection.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
						...
						Intent intent = new Intent(Context,
								AdminStartDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains("In Progress"))
							&& (mTasktype.contains("Detasseling"))) {
						Intent intent = new Intent(Context,
								InProgressDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(
							R.string.activestatus).toString()))
						...
						Intent intent = new Intent(Context,
								AdminStartRogueing.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains("In Progress"))
							&& (mTasktype.contains("Rogueing"))) {
						Intent intent = new Intent(Context,
								InProgressRogueing.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(R.string.tempstop).toString()))
							&& (mTasktype.contains("Detasseling"))) {
						Intent intent = new Intent(Context,
								AdminFreezeDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(R.string.tempstop).toString()))
							&& (mTasktype.contains("Rogueing"))) {
						Intent intent = new Intent(Context,
								AdminFreezeRogueing.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(R.string.tempstop).toString()))
							&& (mTasktype.contains("Inspection"))) {
						Intent intent = new Intent(Context,
								AdminFreezeInspection.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					}
