...
public class AdminReschedule extends Activity implements OnClickListener {
	...
	AdminGetRescheduleTaskList adapter;
	JSONObject jObject;
	String mResponse;
	...
	private void GettingTaskfromServer() {
		...
		try {
			...
			httpPost = new HttpPost(muUrl + "reschedule.php");
			...
			try {
				...
				adapter = new AdminGetRescheduleTaskList(getApplicationContext(),
						menuitemArray);
	...
	protected void NoTaskFoundAlert() {
		// TODO Auto-generated method stub
		AlertDialog alertDialog = new AlertDialog.Builder(AdminReschedule.this)
				.create();
		...
		alertDialog.setButton("Back", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(AdminReschedule.this, AdminHome.class);
