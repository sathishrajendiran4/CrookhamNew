...
public class AdminStartInspection extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) AdminStartInspection.this
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(AdminStartInspection.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(AdminStartInspection.this,
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								AdminStartInspection.this).create();
