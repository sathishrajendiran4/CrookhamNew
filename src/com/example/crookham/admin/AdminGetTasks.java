...
public class AdminGetTasks extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GetConfigDetails();
		progressDialog = ProgressDialog.show(AdminGetTasks.this,
	...
	private void GettingTaskfromServer() {
		...
		try {
			...
			try {
				...
				adapter = new AdminGetTaskList(getApplicationContext(),
						menuitemArray);
	...
	protected void NoTaskFoundAlert() {
		// TODO Auto-generated method stub
		AlertDialog alertDialog = new AlertDialog.Builder(AdminGetTasks.this)
				.create();
		...
		alertDialog.setButton("Back", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(AdminGetTasks.this, AdminHome.class);
