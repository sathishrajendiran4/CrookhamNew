...
public class InProgressInspection extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progressDialog = ProgressDialog.show(InProgressInspection.this,
	...
	private void Level1PullDown() {
		...
		final Dialog dialog = new Dialog(InProgressInspection.this);
	...
	protected void BullRowSelection() {
		...
		final ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				InProgressInspection.this, android.R.layout.select_dialog_item);
	...
	protected void ErrorAlert() {
		...
		alertDialog.setButton2("Cancel", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(InProgressInspection.this,
						AdminGetTasks.class);
				startActivity(intent);
			}
		});
	...
	protected void CallLevel1PullDownValues(String mLevel1Type,
		...
		values.add(mLevel1Type + " > " + mLevel1Section + " > "
				+ mlevel1value);
	...
	private void UpdateInspectionstatus1(String status) {
		...
		try {
			...
			System.err.println("Error1"+exception.toString());
			runOnUiThread(new Runnable() {
				public void run() {
					progressDialog.cancel();
					Toast("Error in Connection");
	...
	private void GetPullDownPerson() {
		...
		try {
			...
			mResponse = httpClient.execute(httpPost, responseHandler);
			mResponse = mResponse.trim().toString();
			System.err.println("ActionResponse"+mResponse);
			runOnUiThread(new Runnable() {
				@SuppressWarnings("deprecation")
				public void run() {
					...
					if (mResponse.contains("Not Found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								InProgressInspection.this).create();
