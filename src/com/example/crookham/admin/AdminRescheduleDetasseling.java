...
public class AdminRescheduleDetasseling extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progressDialog = ProgressDialog.show(AdminRescheduleDetasseling.this,
					...
					if (mResponse1.contains("Not Found")) {
						...
						try {
							...
							ArrayAdapter dataAdapter = new ArrayAdapter(
									AdminRescheduleDetasseling.this,
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent intent = new Intent(AdminRescheduleDetasseling.this,
	...
	protected void SendEmailtoCrew() {
		...
		try {
			...
			i.putExtra(Intent.EXTRA_SUBJECT, "De-Tesseling");
			...
			Toast.makeText(AdminRescheduleDetasseling.this,
	...
	protected void AddtoCalendar() {
		...
		try {
			...
			intent.putExtra("title", "De-Tesseling");
			intent.putExtra("description", "De-Tesseling (" + mTaskid
	...
	protected void SuccessAlert() {
		// TODO Auto-generated method stub
		alertDialog = new AlertDialog.Builder(AdminRescheduleDetasseling.this)
				.create();
	...
	protected void ErrorAddingTask() {
		...
		alertDialog.setMessage("Error in adding De-Tesseling");
		alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
	...
	public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
		...
		if (spinner.getId() == R.id.spinassignedto) {
			...
			Toast.makeText(getApplicationContext(), mCrewid, Toast.LENGTH_LONG).show();
		}
	}
