...
public class AdminStartRogueing extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) AdminStartRogueing.this
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(AdminStartRogueing.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(AdminStartRogueing.this,
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								AdminStartRogueing.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(AdminStartRogueing.this, AdminGetTasks.class);
		startActivity(intent);
	}
