...
public class CrewInProgressRogueing extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) CrewInProgressRogueing.this
		...
		progressDialog = ProgressDialog.show(CrewInProgressRogueing.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(CrewInProgressRogueing.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								CrewInProgressRogueing.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent intent = new Intent(CrewInProgressRogueing.this, CrewGetTasks.class);
		startActivity(intent);
	}
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (mResponse.contains("Success")) {
						...
						// myHandler.postDelayed(updateTimerMethod, 0);
						Intent intent = new Intent(CrewInProgressRogueing.this,
								CrewGetTasks.class);
						startActivity(intent);
					} else {
						ErrorAlert();
