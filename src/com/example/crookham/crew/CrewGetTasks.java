...
public class CrewGetTasks extends Activity implements OnClickListener {
	...
	private void GettingTaskfromServer() {
		...
		try {
			...
			httpPost = new HttpPost(muUrl + "getcrewtasks.php");
			...
			try {
				...
				adapter = new CrewGetTaskList(getApplicationContext(),
						menuitemArray);
	...
	protected void NoTaskFoundAlert() {
		// TODO Auto-generated method stub
		AlertDialog alertDialog = new AlertDialog.Builder(CrewGetTasks.this)
				.create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		Intent intent = new Intent(CrewGetTasks.this, CrewHome.class);
		startActivity(intent);
	}
}
