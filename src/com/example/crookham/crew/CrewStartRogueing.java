...
public class CrewStartRogueing extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) CrewStartRogueing.this
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(CrewStartRogueing.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(CrewStartRogueing.this,
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(CrewStartRogueing.this, CrewGetTasks.class);
		startActivity(intent);
	}
	...
	protected void ErrorAlert() {
		...
		alertDialog.setButton2("Cancel", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(CrewStartRogueing.this,
						CrewGetTasks.class);
				startActivity(intent);
			}
		});
