...
public class StartCrewDetasseling extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) StartCrewDetasseling.this
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(StartCrewDetasseling.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(StartCrewDetasseling.this,
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								StartCrewDetasseling.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(StartCrewDetasseling.this,
				CrewGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						StartCrewDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
