...
public class CrewFreezeRogueing extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) CrewFreezeRogueing.this
		...
		progressDialog = ProgressDialog.show(CrewFreezeRogueing.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(CrewFreezeRogueing.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								CrewFreezeRogueing.this).create();
						...
						AlertDialog alertDialog = new AlertDialog.Builder(
								CrewFreezeRogueing.this).create();
						alertDialog.setTitle("Location not fouind");
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(CrewFreezeRogueing.this,
				CrewGetTasks.class);
		startActivity(intent);
	}
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (mResponse.contains("Success")) {
						...
						/*
						 * Intent intent = new Intent(AdminFreezeRogueing.this,
