...
public class CrewFreezeDetasseling extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) CrewFreezeDetasseling.this
		...
		progressDialog = ProgressDialog.show(CrewFreezeDetasseling.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(CrewFreezeDetasseling.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								CrewFreezeDetasseling.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(CrewFreezeDetasseling.this,
				CrewGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						CrewFreezeDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
