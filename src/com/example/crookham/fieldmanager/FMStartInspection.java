...
public class FMStartInspection extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) FMStartInspection.this
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(FMStartInspection.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(FMStartInspection.this,
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(FMStartInspection.this,
				FMGetTasks.class);
		startActivity(intent);
	}
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (mResponse.contains("Success")) {
						...
						/*
						 * Intent intent = new Intent(AdminStartInspection.this,
