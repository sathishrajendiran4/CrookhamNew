...
public class FMInProgressDetasseling extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) FMInProgressDetasseling.this
		...
		progressDialog = ProgressDialog.show(FMInProgressDetasseling.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(FMInProgressDetasseling.this);
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								FMInProgressDetasseling.this).create();
	...
	public void onBackPressed() {
		...
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(FMInProgressDetasseling.this,
				FMGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						FMInProgressDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
