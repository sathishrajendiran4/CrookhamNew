...
public class FMStartDetasseling extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) FMStartDetasseling.this
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(FMStartDetasseling.this);
		...
		if (gps.canGetLocation()) {
			...
			progressDialog = ProgressDialog.show(FMStartDetasseling.this,
				...
				public void run() {
					...
					if (!mResponse.equals("Not found")) {
						AlertDialog alertDialog = new AlertDialog.Builder(
								FMStartDetasseling.this).create();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(FMStartDetasseling.this,
				FMGetTasks.class);
		startActivity(intent);
	}
		...
		alertDialog.setButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				progressDialog = ProgressDialog.show(
						FMStartDetasseling.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
