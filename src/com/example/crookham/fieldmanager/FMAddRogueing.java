...
public class FMAddRogueing extends Activity implements OnItemSelectedListener,
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GetConfigDetails();
		progressDialog = ProgressDialog.show(FMAddRogueing.this, "In progress",
				"Please wait");
	...
	protected void CrewNotFound(String message) {
		...
		alertDialog.setButton2("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(FMAddRogueing.this, FMHome.class);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		if (spinner.getId() == R.id.spinselectcrew) {
			...
			progressDialog = ProgressDialog.show(FMAddRogueing.this,
	...
	protected void SendEmailtoCrew() {
		...
		try {
			...
			Toast.makeText(FMAddRogueing.this,
	...
	protected void SuccessAlert() {
		// TODO Auto-generated method stub
		alertDialog = new AlertDialog.Builder(FMAddRogueing.this).create();
