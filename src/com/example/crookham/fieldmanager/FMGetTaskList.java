...
public class FMGetTaskList extends BaseAdapter {
	...
	public FMGetTaskList(Context context, JSONArray imageArrayJson) {
		Context = context;
			...
			public void onClick(View v) {
				...
				if (mTaskstatus.contains("Completed")) {
					...
					if ((mTaskstatus.contains(Context.getText(
						...
						Intent intent = new Intent(Context,
								FMStartDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains("In Progress"))
							&& (mTasktype.contains("Detasseling"))) {
						Intent intent = new Intent(Context,
								FMInProgressDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(
							R.string.activestatus).toString()))
						...
						Intent intent = new Intent(Context,
								FMStartRogueing.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains("In Progress"))
							&& (mTasktype.contains("Rogueing"))) {
						Intent intent = new Intent(Context,
								FMInProgressRogueing.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(R.string.tempstop).toString()))
							&& (mTasktype.contains("Detasseling"))) {
						Intent intent = new Intent(Context,
								FMFreezeDetasseling.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(R.string.tempstop).toString()))
							&& (mTasktype.contains("Rogueing"))) {
						Intent intent = new Intent(Context,
								FMFreezeRogueing.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					} else if ((mTaskstatus.contains(Context.getText(R.string.tempstop).toString()))
							&& (mTasktype.contains("Inspection"))) {
						Intent intent = new Intent(Context,
								FMFreezeInspection.class);
						intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
						Context.startActivity(intent);
					}
