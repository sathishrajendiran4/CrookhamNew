...
public class FMAddDeTesseling extends Activity implements
	...
	Button baddtask, bback, bcallcrew;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GetConfigDetails();
		progressDialog = ProgressDialog.show(FMAddDeTesseling.this,
	...
	protected void CrewNotFound(String message) {
		...
		alertDialog.setButton2("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(FMAddDeTesseling.this, FMHome.class);
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		if (spinner.getId() == R.id.spinselectdetasseling) {
			...
			if (mDetasselingno.contains("Open Date")) {
				mDetasselingno = "1";
			}
			System.err.println(mDetasselingno);
		}
	...
	protected void SendEmailtoCrew() {
		...
		try {
			...
			Toast.makeText(FMAddDeTesseling.this,
	...
	protected void SuccessAlert() {
		// TODO Auto-generated method stub
		alertDialog = new AlertDialog.Builder(FMAddDeTesseling.this).create();
