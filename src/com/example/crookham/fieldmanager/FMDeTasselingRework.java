...
public class FMDeTasselingRework extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progressDialog = ProgressDialog.show(FMDeTasselingRework.this,
		...
		if (v == baddtask) {
			...
			if (mDate != null && !mDate.isEmpty()) {
				...
				progressDialog = ProgressDialog.show(
						FMDeTasselingRework.this, "In progress",
						"Please wait");
				new Thread(new Runnable() {
					public void run() {
	...
	protected void SendEmailtoCrew() {
		...
		try {
			...
			Toast.makeText(FMDeTasselingRework.this,
	...
	protected void SuccessAlert() {
		// TODO Auto-generated method stub
		alertDialog = new AlertDialog.Builder(FMDeTasselingRework.this)
				.create();
		...
		alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				alertDialog.dismiss();
				Intent intent = new Intent(FMDeTasselingRework.this,
						FMHome.class);
				startActivity(intent);
			}
		});
