...
public class FMFreezeRogueing extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		locationManager = (LocationManager) FMFreezeRogueing.this
		...
		progressDialog = ProgressDialog.show(FMFreezeRogueing.this,
	...
	private void GetCurrentLocation() {
		// TODO Auto-generated method stub
		gps = new GPSTracker(FMFreezeRogueing.this);
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		myHandler.removeCallbacks(updateTimerMethod);
		Intent intent = new Intent(FMFreezeRogueing.this,
				FMGetTasks.class);
		startActivity(intent);
	}
